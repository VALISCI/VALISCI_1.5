...
export default function VALISCILanding() {
  return (
    <div className="min-h-screen bg-white text-[#0A0A0A] antialiased">
      {/* Header now lives globally in app/layout.tsx */}
      ...
      <main id="main">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-[1200px] px-6 pt-28 pb-24">
            ...
            >
              VALISCI enables confident decisions in environments defined by complexity. We transform intelligence
              into clarity, so leadership can act without hesitation.
            </motion.p>
        ...
        {/* DOCTRINE */}
        <section id="doctrine" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
          <div className="mx-auto max-w-[1200px] px-6 py-28 grid md:grid-cols-12 gap-10">
            <div className="md:col-span-5">
              <h2 className="text-[31px] font-medium" style={{ letterSpacing: "-0.015em" }}>
                Doctrine
              </h2>
        ...
        {/* ETHOS */}
        <section id="ethos" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
        ...
        {/* SYSTEMS */}
        <section id="systems" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
        ...
        {/* INDUSTRIES */}
        <section id="industries" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
          <div className="mx-auto max-w-[1200px] px-6 py-28">
            <h2 className="text-[31px] font-medium" style={{ letterSpacing: "-0.015em" }}>
              Industries
            </h2>
        ...
        {/* BRIEF */}
        <section id="brief" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
          <div className="mx-auto max-w-[1200px] px-6 py-28 grid md:grid-cols-12 gap-10 items-center">
            <div className="md:col-span-7">
              <h3 className="text-[25px] md:text-[31px] font-medium" style={{ letterSpacing: "-0.015em" }}>
                Executive Brief
              </h3>
              ...
              <div className="mt-6 flex gap-4">
                <a
                  className="px-5 py-3 rounded-[16px] bg-[#00C7E3] text-white font-medium focus:outline-none focus:ring-2 focus:ring-[#00C7E3] active:translate-y-px transition"
                  href="/valisci-executive-brief-v1.pdf"
                >
                  Download Brief (PDF)
                </a>
                <a
                  className="px-5 py-3 rounded-[16px] border border-black/10 focus:outline-none focus:ring-2 focus:ring-[#00C7E3] active:translate-y-px transition"
                  href="#contact"
                >
                  Request Briefing
                </a>
        ...
        {/* CONTACT */}
        <section id="contact" className="border-t border-black/10 scroll-mt-28 lg:scroll-mt-36">
          <div className="mx-auto max-w-[1200px] px-6 py-28 grid md:grid-cols-12 gap-10 items-start">
            <div className="md:col-span-6">
              ...
              <form className="mt-6 grid gap-3" onSubmit={(e) => e.preventDefault()}>
                <input
                  className="rounded-[12px] bg-black/[.03] border border-black/10 px-4 py-3 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#00C7E3]"
                  placeholder="Name"
                />
                <input
                  className="rounded-[12px] bg-black/[.03] border border-black/10 px-4 py-3 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#00C7E3]"
                ...
                <textarea
                  className="rounded-[12px] bg-black/[.03] border border-black/10 px-4 py-3 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#00C7E3]"
                  rows={4}
                  placeholder="Context / Objective"
                />
                <button
                  type="submit"
                  className="rounded-[16px] bg-[#00C7E3] text-white font-medium px-5 py-3 focus:outline-none focus:ring-2 focus:ring-[#00C7E3] active:translate-y-px transition"
                >
                  Request Briefing
                </button>
              </form>
            ...
            <div className="md:col-span-6">
              <Card>
                ...
                <Copy>
                  Subscribe for executive releases: doctrine updates, industry indices, and cinematic briefs.
                </Copy>
                <div className="mt-4 flex gap-3">
                  <input
                    className="flex-1 rounded-[12px] bg-black/[.03] border border-black/10 px-4 py-3 placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#00C7E3]"
                    placeholder="Email"
                  />
                  <button className="rounded-[16px] border border-black/10 px-5 py-3 focus:outline-none focus:ring-2 focus:ring-[#00C7E3] active:translate-y-px transition">
                    Subscribe
                  </button>
                </div>
              </Card>
